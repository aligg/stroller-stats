    ...
    return (
        <main>
            ...
            <ul>
                ...
                <li>When you grant write access, we'll also update your description to share month to date stroller mileage from your activity. If you'd like stroller stats to be counted for "Only Me" activities, keep "View data about your private activities" checked.</li>
            ...
            {location.pathname === "/about" && (
                <div>
                    ...
                    <p>Stroller stats <i>can</i> work for Strava activities visible only to you. If you'd like your "Only Me" activities to be counted, keep "View data about your private activities" checked during the authorization step. You can change your choice at anytime by logging out and logging back in again and changing your selections.</p>
